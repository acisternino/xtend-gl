...
class GlApplication
{
    ...
    new(Class<? extends GlDemo> demoClass, int w, int h)
    {
        width  = w
        height = h
    ...
    def runNewt(String demoName)
    {
        ...
        // Animator that calls the window's display() method 30 times per second
        ...
        // Register demo-specific listeners
        demo.window = glWindow
